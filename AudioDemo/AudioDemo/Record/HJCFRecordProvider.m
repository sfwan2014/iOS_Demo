...
{
    NSString *savePath = [HJCFRecordTools audioFilePathFromFileName:fileName];
    [HJCFAudioTurnFormat wavToAmr:_recordedTmpFile.absoluteString amrSavePath:savePath];
    
    NSString *lastPathComponent = [_recordedTmpFile.absoluteString lastPathComponent];
    [HJCFRecordTools deleteAudioForKey:lastPathComponent];
}
